...
%
\author{ Narsupalli Sai Vamsi% <-this % stops a space
% <-this % stops a space
...
\begin{lstlisting}
 wget https://github.com/NSaiVamsi/Probability/blob/main/Codes/1/exrand.c
 wget https://github.com/NSaiVamsi/Probability/blob/main/Codes/1/coeffs.h
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/NSaiVamsi/Probability/blob/main/Codes/1/cdf_plot.py
\end{lstlisting}
...
\solution
\begin{lstlisting}
wget https://github.com/NSaiVamsi/Probability/blob/main/Codes/1/1.4.c
\end{lstlisting}
...
\solution
\begin{lstlisting}
wget https://github.com/NSaiVamsi/Probability/blob/main/Codes/2/2.1.c
wget https://github.com/NSaiVamsi/Probability/blob/main/Codes/2/coeffs.h
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/NSaiVamsi/Probability/blob/main/Codes/2/2.3.py
\end{lstlisting}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{./gau2}
...
\solution
Running the below code gives Mean = 0.000326 Variance= 1.000907
 \begin{lstlisting}
wget https://github.com/NSaiVamsi/Probability/blob/main/Codes/2/2.4.c
\end{lstlisting}
Command used:
\begin{lstlisting}
gcc 2.4.c -lm
...
\begin{lstlisting}
https://github.com/NSaiVamsi/Probability/blob/main/Codes/3/3.1/V.py
\end{lstlisting}
Use the below command in the terminal to run the code:
\begin{lstlisting}
python3 V.py
...
\begin{lstlisting}
https://github.com/NSaiVamsi/Probability/blob/main/Codes/3/3.1/V._cdf.py
\end{lstlisting}
Use the below command to run the code:
\begin{lstlisting}
python3 V_cdf.py
